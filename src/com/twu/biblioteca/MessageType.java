...
public enum MessageType{
    ...
    CHECKOUT_INTRO("Enter the title of the book to checkout"),
    RETURN_BOOK_INTRO("Enter the title of the book you would like to return"),
    ...
    RETURN_FAILED("That is not a valid book to return"),
